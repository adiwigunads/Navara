...
<body class="min-h-screen bg-white font-sans text-navara-900 antialiased">
    <div class="flex min-h-screen">
        <aside class="fixed inset-y-0 left-0 z-40 flex w-72 flex-col border-r border-navara-100 bg-gradient-to-b from-navara-600 to-navara-800 text-white shadow-xl lg:static">
            <div class="flex h-20 items-center gap-3 border-b border-white/10 px-6">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-navara-100">Dashboard Administrative</p>
                </div>
            </div>
            ...
            <nav class="flex-1 space-y-1 p-4 pt-2">
                @php
                    $menus = [
                        ['route' => 'administrative.dashboard', 'label' => 'Dashboard', 'match' => ['administrative.dashboard'], 'icon' => 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z'],
                        ['route' => 'administrative.objek-wisata.index', 'label' => 'Kelola Data Objek Wisata', 'match' => ['administrative.objek-wisata.*'], 'icon' => 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                        ['route' => 'administrative.alternatif.index', 'label' => 'Kelola Alternatif', 'match' => ['administrative.alternatif.*'], 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'],
                        ['route' => 'administrative.moora.index', 'label' => 'Perhitungan MOORA', 'match' => ['administrative.moora.*'], 'icon' => 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z'],
                        ['route' => 'administrative.ranking.index', 'label' => 'Lihat Hasil Ranking', 'match' => ['administrative.ranking.*'], 'icon' => 'M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12'],
                    ];
                @endphp
            ...
            <header class="sticky top-0 z-30 border-b border-navara-100 bg-white/95 px-6 py-5 backdrop-blur-md lg:px-10">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        @endif
                        <h1 class="text-xl font-black text-navara-800">@yield('heading', 'Dashboard Administrative')</h1>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="rounded-2xl bg-navara-50 px-4 py-2 text-right">
                            ...
                            <p class="text-xs text-navara-500">Administrative</p>
                        </div>
                    </div>
                </div>
            </header>
