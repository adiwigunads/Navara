...
@section('title', 'Lihat Hasil Ranking')
@section('breadcrumb', 'Dashboard / Lihat Hasil Ranking')
@section('heading', 'Lihat Hasil Ranking')
@section('subheading', 'Tampilkan hasil ranking objek wisata berdasarkan MOORA')
...
@section('content')
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        @if ($ranking->isNotEmpty())
            <a href="{{ route('administrative.ranking.download') }}" class="inline-flex items-center gap-2 rounded-xl bg-navara-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-navara-600">
